DREIDING_DATA = {
    ...
    "Li_3": (1.336, 109.471, 4.02, 0.095, 0.0, 14.23), # fake, same as Cu, but B
#    "B_2": (0.790, 120.0, 4.02, 0.095, 0.0, 14.23),
    ...
    "O_R_HB": (0.660, 120.0, 3.4046, 0.0957, 0.0, 13.483),
    ...
    "S_3+2": (1.040, 92.1, 4.03, 0.344, 0.0, 12.0), ### fake!
    ...
    "Zn3+2": (1.330, 109.471, 4.54, 0.055, 0.0, 12.0),### fake!
